 ...
 */
@WebServlet(name = "CreateShipment", urlPatterns = {"/CreateShipment"})
public class CreateShipment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CreateShipment</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CreateShipment at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
