  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-faded py-lg-4">
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">Crear
          <strong>Carga</strong>
        </h2>
        <hr class="divider">
        <div class="row">
    ...
    <div class="form-group col-lg-4>
        ...
        <input type="number" name="Cod_Shipment"class="form-control" />
    </div>
    <div class="form-group col-lg-4>
        <label for="name">Contract Code:</label>
        <input type="number" name="Cod_Contract"  class="form-control"/>
        <br
        <label for="name">Ship Code:</label>
        <input type="number" name="Cod_Ship" class="form-control" />
    </div>    
    <div class="form-group col-lg-4>
