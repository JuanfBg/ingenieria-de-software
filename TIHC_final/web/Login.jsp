...
EL HOMBRE CAIMÁN</div>
 ...
 <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">To
          <strong>Login</strong>
        </h2>
        ...
        <form id="formularioLogin" action="LoginServlet" method="POST">
          <div class="row">
            <div class="form-group col-lg-4">
              ...
              <label class="text-heading">Nombre de Usuario:</label>
              <input type="text" name="user" class="form-control">
           
            </div>
              
            <div class="form-group col-lg-4">
              <label class="text-heading">Constraseña:</label>
              <input type="email" name="password" class="form-control">
            </div>
         
            <div class="form-group col-lg-12">
              <button type="submit" class="btn btn-secondary" value="Ingresar" id="botonLogin">Ingresar</button>
            </div>
