...
EL HOMBRE CAIMÁN</div>
  ...
  <div class="container">
      ...
      <hr class="divider">
        ...
        <input placeholder="País"type="text" name="name" value="${country.getName()}" /> 
       
        <input placeholder="Locale X"  type="text" name="x" value="${country.getX()}" />  
       
        <input placeholder="Locale Y" type="text" name="y"value="${country.getY()}" /> 
       
